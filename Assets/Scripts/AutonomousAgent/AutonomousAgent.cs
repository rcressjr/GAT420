...
public class AutonomousAgent : Agent {
    ...
    void Update() {
        ...
        if (gameObjects.Length != 0)
        {
            movement.acceleration += steering.Cohesion(this, gameObjects) * agentData.cohesionWeight;

            movement.acceleration += steering.Seperation(this, gameObjects, agentData.separationRadius) * agentData.separationWeight;

            movement.acceleration += steering.Alignment(this, gameObjects) * agentData.alignmentWeight;
        }
